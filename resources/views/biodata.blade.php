...
<head>
    ...
    <script>
        ...
        fbq('init', '3020015081594555');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=3020015081594555&ev=PageView&noscript=1" /></noscript>
...
<body>
    ...
    <div class="main_bio_body">

        <div class="inner_card" style="display: flex;">
            <div class="bio_main_image">
                ...
                <div class="bottom_image">
                    <img src="image/biodata-images/bottomImg.jpeg" alt="" class="bottom_image">
                    <img src="image/biodata-images/ring.png" alt="" class="bottom_ring_image">

                    <div class="bio_contact">
                        <div class="main_contact_section">
                            <!-- <div class="personal_contact_detail"> Contact</div>
                            <p class="information_detail">+91 8238974705</p> -->
                            ...
                            <p class="information_detail">Taluka : Gadhda </p>
                            <p class="information_detail">District : Botad </p> -->
                        ...
                        <ul>Cyber Security Enthusiast</ul> -->
                        <!-- </li> -->
                    </div>

                </div>
            </div>
            <div class="bio_second_part">
...
<style>
    .name_mota_papa{
        font-size: 20px;
            ...
            <div class="image_right" style="float: right;">
                <img class="top" src="image/biodata-images/pic1.jpeg" alt="">
